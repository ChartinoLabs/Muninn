"""Parser for 'show ipv6 eigrp interfaces detail' command on IOS-XE."""
...
class Ipv6EigrpInterfaceDetailEntry(TypedDict):
    """Schema for a single IPv6 EIGRP interface detail entry."""
...
class ShowIpv6EigrpInterfacesDetailResult(TypedDict):
    """Schema for 'show ipv6 eigrp interfaces detail' parsed output."""

    as_number: int
    interfaces: dict[str, Ipv6EigrpInterfaceDetailEntry]


_AS_PATTERN = re.compile(r"^EIGRP-IPv6 Interfaces for AS\((?P<as_number>\d+)\)")
...
class ShowIpv6EigrpInterfacesDetailParser(
    BaseParser[ShowIpv6EigrpInterfacesDetailResult],
):
    """Parser for 'show ipv6 eigrp interfaces detail' command.
    ...
    @classmethod
    def parse(cls, output: str) -> ShowIpv6EigrpInterfacesDetailResult:
        """Parse 'show ipv6 eigrp interfaces detail' output.

        Args:
            output: Raw CLI output from the command.

        Returns:
            Parsed IPv6 EIGRP interface detail data.
        ...
        return ShowIpv6EigrpInterfacesDetailResult(
            as_number=as_number,
